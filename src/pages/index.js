                    ...
                    <Container>
                        <Row>
                            <Col md={{ size: 5, offset: 4 }}>
                                ...
                                <p>
                                    Hi, my name is Sebastian and I'm working
                                ...
                                <p>
                                    I like starting new endeavors and
                                    challenges.
                                </p>
                                <p>
                    ...
                    <Container>
                        <Row>
                            ...
                            <Col md="4" className="text-center mb-5">
                                ...
                                <h3>UX Consultant</h3>
                                <p>
                                    Define customer experience vision and
                                    success criterias to have amazing
                                    experiences around your products to create
                                    happy customers.
                                </p>
                            </Col>
                            <Col md="4" className="text-center mb-5">
                                ...
                                <h3>UI/UX Design</h3>
                                <p>
                                    Follow the User Centered Design process to
                                    define, create and test great User
                                    Interfaces and flows that are easy to use.
                                </p>
                            </Col>
                            <Col md="4" className="text-center mb-5">
                                ...
                                <h3>FrontEnd Dev</h3>
                                <p>
                                    Handcrafted websites to improve online
                                    presence working with high standards
                                    providing mobile and accesible sites.
                                </p>
                            </Col>
                        </Row>
                    </Container>
